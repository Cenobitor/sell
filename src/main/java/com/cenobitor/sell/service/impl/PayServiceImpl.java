...
import com.cenobitor.sell.utils.JsonUtil;
import com.cenobitor.sell.utils.MathUtil;
 ...
 * @Author: Cenobitor
 * @Description:
 * @Date: Created in 12:25 PM 2018/4/17
 * @Modified By:
 */
@Service
@Slf4j
public class PayServiceImpl implements PayService {
    ...
    public PayResponse notify(String notifyData) {
        ...
        if (!MathUtil.equals(payResponse.getOrderAmount(),orderDTO.getOrderAmount().doubleValue())){
            log.info("[微信支付] 异步通知,订单金额不一致,orderId={},微信通知金额={},系统金额={}",payResponse.getOrderId()
