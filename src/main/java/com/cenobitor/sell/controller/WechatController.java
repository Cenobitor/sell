 ...
 * @Author: Cenobitor
 * @Description:
 * @Date: Created in 9:05 PM 2018/4/15
 * @Modified By:
 */
@Controller
...
//        log.info("[微信网页授权] 获取code,result={}",result);
    ...
    public String qrUserInfo(@RequestParam("code") String code,
                           @RequestParam("state") String returnUrl){
        return getUserInfo(code, returnUrl);
    }

    private String getUserInfo(@RequestParam("code") String code, @RequestParam("state") String returnUrl) {
        try {
            WxMpOAuth2AccessToken wxOpenOAuth2AccessToken = wxOpenService.oauth2getAccessToken(code);
